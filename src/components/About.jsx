...
function About(props) {
    ...
    return (
        ...
        >
            ...
            <span className="font-extrabold text-sm md:text-xl"><span className={`${props.theme ? 'text-blue' : 'text-green'}`}>FULL STACK</span> DEVELOPER</span>
            ...
            <span className={`${props.theme ? 'text-blue' : 'text-green'}`}>Passionate</span> full stack developer with a knack for solving complex problems and crafting efficient solutions.
            </span>
            <br />
            ...
            >
                <a 
                    className="cursor-none" href="https://www.linkedin.com/in/vishnu-as-/"
                >
                    <img 
                ...
                <a className="cursor-none" href="https://github.com/vishnuinzane69">
                    <img 
                ...
                <a className="cursor-none" href="https://www.instagram.com/vixnu._/">
                    <img 
                ...
                <a className="cursor-none" href="https://api.whatsapp.com/send?phone=918137874361">
                    <img 
            ...
            <a 
                className="font-semibold cursor-none flex flex-row gap-1 items-center transition-all duration-200 hover:scale-95" href="mailto:vishnuas3203@gmail.com"
                onMouseEnter={handleMousePointer}
                onMouseLeave={handleMousePointerLeave}
            >
                <img 
                    ...
                    className="w-5 h-5"
                />
                <span className={`${props.theme ? 'text-dark' : 'text-light'}`}>vishnuas3203@gmail.com</span>
            </a>
            <a 
            ...
            >
                <img 
                    ...
                    className="w-5 h-5"
                />
                <span className={`${props.theme ? 'text-dark' : 'text-light'}`}>+91 8137874361</span>
            </a>
        </div>
    )
}
